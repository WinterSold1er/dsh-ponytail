...
//
// Upstream adaptation notes (vs https://github.com/DietrichGebert/ponytail):
//   - `disable-model-invocation: true` (user-invoked skills such as
//     ponytail-help etc.) maps to invocation.modelInvocable: false, so
//     DSH keeps the upstream invocation semantics.
//   - Skill files ship verbatim, including folded multi-line
//     `description: >` frontmatter — parseFrontmatter below handles folded
//     scalars natively (joined with single spaces, matching YAML semantics).
//
// @module dsh-ponytail
